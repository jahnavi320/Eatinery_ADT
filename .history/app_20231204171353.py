...
def restaurants():
    ...
    if clicked_button == 'City':
        print(clicked_button)
        pass
    elif clicked_button == 'Attraction':
        # Perform actions for the Attraction button
        print(clicked_button)
        pass
    elif clicked_button == 'Zipcode':
        # Perform actions for the Zipcode button
        print(clicked_button)
        pass
